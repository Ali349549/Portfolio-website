                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-8">
                    <div className="p-6 rounded-xl border-white/10 border hover:-translate-y-1 transition-all">
                        <h3 className="text-xl font-bold mb-4"> 🏫 Education </h3>
                            <a href = "https://www.torontomu.ca/" target="_blank" rel="noopener noreferrer">
                                <img src = "/src/assets/tmu.jpg" className = "w-32 h-32 object-contain mx-auto mb-2"></img>
                            </a>
                    ...
                    <div className="p-6 rounded-xl border-white/10 border hover:-translate-y-1 transition-all">
                        ...
                        <a href = "https://markhammasjid.ca/" target="_blank" rel="noopener noreferrer">
                                <img src = "/src/assets/ISM.jpg" className = "w-64 h-32 object-contain mx-auto mb-2"></img>
                        </a>
